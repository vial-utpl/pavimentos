...
function loadGraph3() {
    var ctx = document.getElementById("subBaseBituminoso").getContext('2d');
    ...
    var probsbit = parseFloat($('#subbase-crc').val());
    var txtebsbit = $('#subbase-crc-td').text();
    var bsbitfi = $('#dat-subbase-grafi').text();
    ...
    var bsbit1 = { x: 0, y: document.getElementById("dat-subbase-graf").value, r: "a2" + " = " + document.getElementById("subbasea2").value };
    window.myChart3.data.datasets[6].data[0, 0, 0] = bsbit1;
    var bsbit2 = { x: document.getElementById("dat-subbase-grafi").value, y: document.getElementById("dat-subbase-graf").value, r: document.getElementById("subbase-crc-td").textContent + " = " + document.getElementById("subbase-crc").value };
    window.myChart3.data.datasets[6].data[1, 1, 1] = bsbit2;
    var bsbit3 = { x: 6, y: document.getElementById("dat-subbase-graf").value, r: "Módulo resiliente" + " = " + document.getElementById("subbaseMb").value };
