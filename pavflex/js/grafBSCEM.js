...
function loadGraphBaseCemento() {
    var ctx = document.getElementById("chartCemento").getContext('2d');
    ...
    var probscem = parseFloat($('#base_caracteristicas').val());
    var txtebscem = $('#base_caracteristicas_td').text();
    var bscemfi = $('#coord_x_base_graf').text();

    if ((txtebscem == "RCNC") && (200 <= probscem) && (probscem <= 1000)) {
        ...
        $("#prop_base_clc_grafica").val(grafrcbs);
    ...
    var bscem1 = { x: 0, y: document.getElementById("prop_base_clc_grafica").value, r: "a2" + " = " + document.getElementById("a2").value };
    window.myChart2.data.datasets[6].data[0, 0, 0] = bscem1;
    var bscem2 = { x: document.getElementById("coord_x_base_graf").value, y: document.getElementById("prop_base_clc_grafica").value, r: document.getElementById("base_caracteristicas_td").textContent + " = " + document.getElementById("base_caracteristicas").value };
    window.myChart2.data.datasets[6].data[1, 1, 1] = bscem2;
    var bscem3 = { x: 6, y: document.getElementById("prop_base_clc_grafica").value, r: "Módulo resiliente" + " = " + document.getElementById("Mb").value };
