...
function loadGraph10() {
    ...
    var modulo_elastico_asfalto = document.getElementById("modulo_elastico_asfalto").value;
    var modulo_elastico = (modulo_elastico_asfalto/1000)
    var res1 = { x: modulo_elastico, y: document.getElementById("coeficiente_a1_oculto").value, r: "Intersección" };
    window.myChart5.data.datasets[0].data[0, 0, 0] = res1;
    var res2 = { x: modulo_elastico, y: 0, r: document.getElementById("modulo_elastico_asfalto").value };
    window.myChart5.data.datasets[0].data[1, 1, 1] = res2;
    var res3 = { x: 0, y: document.getElementById("coeficiente_a1_oculto").value, r: document.getElementById("a1").value };
    window.myChart5.data.datasets[1].data[0, 0, 0] = res3;
    var res4 = { x: modulo_elastico, y: document.getElementById("coeficiente_a1_oculto").value, r: "Intersección" };
